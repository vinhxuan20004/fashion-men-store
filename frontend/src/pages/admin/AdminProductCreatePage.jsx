      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-100">
        <div>
          ...
          <div className="flex items-center gap-3">
             ...
             <h1 className="text-xl font-semibold text-slate-800">Thêm sản phẩm mới</h1>
          </div>
        </div>
        ...
        <div className="space-y-10">
          ...
          <div className="bg-white rounded-xl border border-slate-100 p-6 shadow-sm">
             ...
             <div className="space-y-5">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-slate-400">Tags liên quan</label>
                  <input
                    {...register('tags')}
                    className="w-full px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-sm font-normal text-slate-900 focus:outline-none focus:ring-4 focus:ring-primary-500/10 transition-all"
                    placeholder="VD: sơ mi, công sở..."
                   />
                </div>
             ...
             <div className="grid grid-cols-2 gap-3">
                {imagePreviews.map((preview, idx) => (
                  <div key={idx} className="relative aspect-[3/4] group">
                    <img src={preview} alt="" className="w-full h-full object-cover rounded-lg border border-slate-100" />
                    <button
                      type="button"
