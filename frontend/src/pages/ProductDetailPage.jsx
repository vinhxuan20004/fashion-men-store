            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 flex flex-col gap-2">
                <div className="flex items-end gap-3">
                  <span className="text-4xl font-display font-black text-primary-600 tracking-tighter">
              ...
              <div className="space-y-6 pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 pt-4">
                  <div className="md:col-span-4 flex items-center justify-between px-6 py-4 bg-slate-50 rounded-2xl border border-slate-100">
                    <button
                    ...
                    <span className="font-display font-black text-xl text-slate-900">{quantity}</span>
                    <button
                  ...
                  <button
                    ...
                    className="md:col-span-8 group relative bg-primary-600 hover:bg-primary-700 disabled:bg-slate-200 text-white py-5 rounded-2xl font-black text-sm uppercase tracking-[0.2em] shadow-2xl shadow-primary-600/20 active:scale-95 transition-all overflow-hidden"
                  >
        ...
        <div className="mt-32 grid lg:grid-cols-12 gap-16">
          <div className="lg:col-span-7 space-y-16">
            ...
            <div className="grid grid-cols-2 gap-8 pt-12">
               <div className="flex gap-6 p-8 rounded-[2.5rem] bg-slate-900 text-white">
               ...
               <div className="flex gap-6 p-8 rounded-[2.5rem] bg-primary-600 text-white">
          ...
          <div className="lg:col-span-5">
            ...
            <section className="space-y-8 animate-fade-in">
              ...
              {product.averageRating > 0 && (
                <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100 flex items-center justify-around text-center">
              ...
              <div className="space-y-6">
                {reviews.length > 0 ? (
                  ...
                  <div className="text-center py-16 bg-slate-50 rounded-[2.5rem] border border-dashed border-slate-200">
                    ...
                    <p className="text-slate-400 font-bold italic">Trở thành người đầu tiên chia sẻ cảm nhận về siêu phẩm này!</p>
                  </div>
                )}
              </div>
              ...
              <div className="pt-8 border-t border-slate-100">
                ...
                {isAuthenticated ? (
                  <form onSubmit={handleSubmit(onReviewSubmit)} className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 space-y-6">
                    <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-slate-900 hover:bg-primary-600 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] transition-all shadow-xl shadow-slate-900/10 active:scale-95 flex items-center justify-center gap-3"
                    >
                      {submitReview ? <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : 'GỬI ĐÁNH GIÁ NGAY'}
                    </button>
                  </form>
                ) : (
                  <div className="text-center p-12 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                    <p className="text-slate-500 font-bold mb-6 italic">Gia nhập cộng đồng Men's Fashion để nâng tầm tiếng nói của bạn!</p>
                    <Link to="/login" className="btn-primary px-8 py-3 text-xs tracking-[0.2em] shadow-none">ĐĂNG NHẬP NGAY</Link>
                  </div>
                )}
              </div>
            </section>
