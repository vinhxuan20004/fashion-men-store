                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        ...
                        <div className="mt-6 flex flex-wrap items-end justify-between gap-4">
                          ...
                          <div className="text-right">
                             ...
                             <div className="text-xl font-display font-black text-primary-600 tracking-tighter italic price-bold">
            ...
            <div className="bg-slate-50 rounded-[3rem] p-10 border border-slate-100 sticky top-28 backdrop-blur-3xl shadow-2xl shadow-slate-200/50">
               ...
               <div className="space-y-4 mb-10 pb-10 border-b border-slate-200/50 text-sm">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-black text-slate-900 price-bold">{formatCurrency(cartSubtotal)}</span>
                  </div>
                  {discount > 0 && (
                    <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`font-black price-bold ${shipping === 0 ? 'text-emerald-600' : 'text-slate-900'}`}>
