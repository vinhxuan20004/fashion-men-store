           ...
           <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className={`text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full shadow-sm ${getOrderStatusColor(order.status)}`}>
                      ...
                      <div key={idx} className="p-8 flex items-center gap-8 group">
                        <Link to={`/products/${product.slug}`} className="relative flex-shrink-0 group-hover:scale-105 transition-transform duration-500">
                          <img 
                             src={image} 
                             alt={product.name} 
                             className="w-24 h-32 object-cover rounded-3xl shadow-lg shadow-slate-200/50"
                             onError={(e) => { e.target.src = 'https://via.placeholder.com/100x120?text=No+Image' }} 
                          />
                        </Link>
                        <div className="flex-1 min-w-0">
                          <Link to={`/products/${product.slug}`} className="text-lg font-display font-black text-slate-900 hover:text-primary-600 transition-colors uppercase italic line-clamp-1 leading-tight mb-2">
                             {product.name || 'Sản phẩm Fashion'}
                          </Link>
                          ...
                          <div className="mt-4 flex items-center justify-between">
                             <p className="text-xl font-display font-black text-primary-600 italic tracking-tighter">
               ...
               <div className="relative z-10">
                 ...
                 <div className="space-y-4 mb-10 text-sm">
                   ...
                   <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-slate-400">
                     ...
                     <span className={order.shippingFee === 0 ? 'text-emerald-400' : ''}>
                 ...
                 <div className="flex justify-between items-end mb-10">
                    ...
                    <span className="text-3xl font-display font-black text-primary-400 tracking-tighter italic">
